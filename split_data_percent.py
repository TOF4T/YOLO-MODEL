...
def allocate_split_custom(n):
    ...
    # 3. Thuật toán mượn ảnh an toàn (Dự phòng cho các trường hợp đặc biệt)
...
def split_dataset(root_dir, output_dir):
    ...
    # Ép sort danh sách file để đảm bảo tính nhất quán qua các lần chạy
    ...
    print("✅ Hoàn tất! Dữ liệu đã được chia chính xác.")
